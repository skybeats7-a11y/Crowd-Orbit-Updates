  ...
  async function openPerson(id){
    ...
    body.innerHTML=`
      ...
      <section class="co80-profile-section"><span class="co80-kicker">KNOWN DETAILS</span><div class="co80-detail-grid">
        ...
        <label>Role<input id="co80-role" value="${esc(p.role==='Unknown'?'':p.role||'')}"></label><label>Location<input id="co80-location" value="${esc(p.location||'')}"></label>
      ...
      </div><div class="co80-actions"><button id="co80-save" class="co70-btn">Save & re-analyse</button>${p.source_url?'<button id="co80-open-source" class="co70-btn ghost">Open source profile</button>':''}<button id="co80-delete" class="co80-danger">Delete</button></div><div id="co80-person-status" class="co70-status"></div></section>
